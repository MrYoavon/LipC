...
class CallHandler:
    """
    Handles signaling messages for calls: invite, accept, reject, end, video-state, model preference.
    """

    async def handle_call_invite(self, websocket, data, aes_key):
        """
        ...
        Returns:
            None
        """
        payload = await self._validate_jwt(websocket, data, aes_key, "call_invite")
        if payload is None:
            return
    ...
    async def handle_call_accept(self, websocket, data, aes_key):
        """
        ...
        Returns:
            None
        """
        payload = await self._validate_jwt(websocket, data, aes_key, "call_accept")
        if payload is None:
            return
    ...
    async def handle_call_reject(self, websocket, data, aes_key):
        """
        ...
        Returns:
            None
        """
        payload = await self._validate_jwt(websocket, data, aes_key, "call_reject")
        if payload is None:
            return
        callee, caller = payload.get("from"), payload.get("target")
    ...
    async def handle_call_end(self, websocket, data, aes_key):
        """
        ...
        Returns:
            None
        """
        payload = await self._validate_jwt(websocket, data, aes_key, "call_end")
        if payload is None:
            return
    ...
    async def handle_video_state(self, websocket, data, aes_key):
        """
        ...
        Returns:
            None
        """
        payload = await self._validate_jwt(websocket, data, aes_key, "video_state")
        if payload is None:
            return
    ...
    async def handle_set_model_preference(self, websocket, data, aes_key):
        """
        ...
        Returns:
            None
        """
        payload = await self._validate_jwt(websocket, data, aes_key, "set_model_preference")
        if payload is None:
            return
