    ...
    return Scaffold(
      appBar: AppBar(
        title: FittedBox(
          ...
          child: Text("${contact?.name ?? contactId} | ${DateFormat.yMMMd().add_Hm().format(entry.startedAt)}"),
        ),
      ),
          ...
          return Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isMe ? Theme.of(context).colorScheme.primary.withValues(alpha: 0.8) : Colors.grey.shade200,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    // format HH:mm or whatever you like:
